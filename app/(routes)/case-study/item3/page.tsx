            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-primary-blue/5">
                  <th className="px-6 py-4 text-base leading-[1.5em] text-footer-heading font-semibold font-poppins text-left first:rounded-tl-2xl last:rounded-tr-2xl">
                    Head (m)
                  </th>
                  <th className="px-6 py-4 text-base leading-[1.5em] text-footer-heading font-semibold font-poppins text-left first:rounded-tl-2xl last:rounded-tr-2xl">
                    Flow (L/s)
              ...
              <tbody>
                <tr className="border-t border-footer-border/30 hover:bg-primary-blue/2 transition-colors">
                  <td className="px-6 py-4 text-base leading-[1.5em] text-footer-text font-normal font-poppins">
                    0.1
                  </td>
                  <td className="px-6 py-4 text-base leading-[1.5em] text-footer-text font-normal font-poppins">
                    35.374
                ...
                <tr className="border-t border-footer-border/30 hover:bg-primary-blue/2 transition-colors last:rounded-b-2xl">
                  <td className="px-6 py-4 text-base leading-[1.5em] text-footer-text font-normal font-poppins first:rounded-bl-2xl">
                    2.5
                  </td>
                  <td className="px-6 py-4 text-base leading-[1.5em] text-footer-text font-normal font-poppins last:rounded-br-2xl">
                    504.908
                  </td>
                </tr>
              </tbody>
