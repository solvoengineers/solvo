...
export const project11: IFullProject = {
  ...
  seoTitle:
    "Warehouse HVAC Natural Flow CFD Study",
  description:
    "HVAC simulation of a warehouse using CFD in Ansys to improve natural ventilation efficiency and optimize airflow patterns.",
